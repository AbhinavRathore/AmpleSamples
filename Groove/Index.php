	...
	<body background= "images/Wall1.jpg">
		<header>
			...
			<form class="form-inline">
				...
				<div class="col-md-1" id="lin" style="padding: 10px;"><input type="submit" value="Login" id="log" name="submit"></div>
				<div class="col-md-1" style="padding: 10px;" id="fb1"><button class="fa fa-facebook"></button></div>
